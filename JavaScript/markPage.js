...
(function(){
    function markPage(targ) {
        ...
        that.on("mouseup",function(e){
            ...
            if (r!= "") {
                var tooltip = '<div class="markPanel top" id="tooltip"><div class="arrow"></div><div class="markPanel-title">添加批注：<button class="subMark">添加</button></div><div class="markPanel-content"><div>标注颜色：<input type="color" id="markColor" value="#ffffff"></div><div><span style="vertical-align:top">批注内容：</span><textarea rows="5" cols="35" style="padding:5px;color:#666;resize:none"></textarea></div></div></div>';
                $("body").append(tooltip);
                $("#tooltip").css({
                    "top": (e.pageY + y) + "px",
                    "left": (e.pageX - x) + "px"
